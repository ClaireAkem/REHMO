              ...
              <div className="container relative z-10 py-24 md:py-32 lg:py-40">
                <div className="flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto">
                  ...
                  <p className="text-lg md:text-xl text-white/90 max-w-2xl">
                    Explore thousands of traditional and modern African recipes,
                    create personalized meal plans, and connect with a community
                    of food lovers.
                  </p>
                ...
                <div className="lg:col-span-5">
                  <div className="flex flex-col items-center text-center mb-12">
                    ...
                    <p className="text-muted-foreground max-w-2xl">
                      Nutritious and delicious African recipes that will help
                      you maintain a balanced diet without sacrificing authentic
                      flavors.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Card className="overflow-hidden">
                      <div className="relative h-48 w-full overflow-hidden">
                        <Image
                          src="/Traditional-Ethiopian-Meal.jpg?height=400&width=600"
                      ...
                      <CardHeader>
                        ...
                        <CardDescription>
                          Traditional sourdough flatbread with colorful
                          vegetable stews
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                    ...
                    <Card className="overflow-hidden">
                      <div className="relative h-48 w-full overflow-hidden">
                        <Image
                          src="/African_Pilau.jpg?height=400&width=600"
                          alt="African Pilau"
                          fill
                          className="object-cover transition-transform hover:scale-105"
                        />
                      ...
                      <CardHeader>
                        <CardTitle>African Pilau</CardTitle>
                        <CardDescription>
                        A very unique dish prepared from pilau masala,beef and rice. East African Pilau is a traditional, beautiful fragrant rice dish made with many aromatic spices that adds an amazing depth of flavor to the rice. It can be made with either beef or chicken.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="flex items-center justify-between text-sm">
                    ...
                    <Card className="overflow-hidden">
                      <div className="relative h-48 w-full overflow-hidden">
                        <Image
                          src="/pepper-soup.jpg?height=400&width=600"
                      ...
                      <CardHeader>
                        ...
                        <CardDescription>
                          Spicy and warming soup with traditional African spices
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="flex items-center justify-between text-sm">
            ...
            <div className="container">
              <div className="flex flex-col items-center text-center mb-12">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-3xl font-bold">
                    Trending African Dishes
                  </h2>
                </div>
                <p className="text-muted-foreground max-w-2xl">
                  Discover the most popular African recipes loved by our
                  community from across the continent.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  <div className="relative h-64 w-full md:w-1/2 rounded-lg overflow-hidden">
                    <Image
                      src="/nigerian-jollof.jpg?height=400&width=400"
                      alt="Jollof Rice"
                      fill
                  ...
                  <div className="md:w-1/2">
                    ...
                    <p className="text-muted-foreground mb-4">
                      The crown jewel of West African cuisine - a flavorful
                      one-pot rice dish that brings families together.
                    </p>
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  <div className="relative h-64 w-full md:w-1/2 rounded-lg overflow-hidden">
                    <Image
                      src="/doro-wat.jpg?height=400&width=400"
                  ...
                  <div className="md:w-1/2">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Ethiopia's national dish - a rich, spicy chicken stew
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="bg-background border">
                  ...
                  <CardContent>
                    ...
                    <p className="text-muted-foreground">
                      "REHMO has reconnected me with my grandmother's recipes.
                      The authentic flavors and detailed instructions make it
                      easy to recreate traditional dishes."
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-background border">
                  ...
                  <CardContent>
                    ...
                    <p className="text-muted-foreground">
                      "The meal planning feature is incredible! I can plan
                      authentic African meals for the whole week and my family
                      loves the variety."
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-background border">
                  ...
                  <CardContent>
                    ...
                    <p className="text-muted-foreground">
                      "I love how REHMO showcases the nutritional benefits of
                      African ingredients. It's helping my clients embrace
            ...
            <div className="container">
              <div className="flex flex-col items-center text-center space-y-6 max-w-3xl mx-auto">
                ...
                <p className="text-lg text-white/90 max-w-2xl">
                  Join REHMO today and discover the rich flavors of African
                  cuisine with personalized meal plans and authentic recipes.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Button
                    size="lg"
